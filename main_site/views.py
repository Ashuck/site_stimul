...
def get_services_page(request):
    services = """Разработка сметной документации
        ...
        Пересчет сметной стоимости по постановлению Правительства РФ от 9 августа 2021 N 1315 «О внесении изменений в некоторые акты Правительства Российской Федерации»
